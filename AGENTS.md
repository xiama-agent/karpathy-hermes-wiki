...
## 第 6 章：与 SOUL.md 协作（精简版）

**核心原则**：SOUL.md 只可被"更新龙虾"指令修改。AGENTS.md 负责具体操作细节。

```
触发：SOUL.md 被"更新龙虾"指令修改
动作：
  1. 读新版本 SOUL.md，检查是否需要同步 AGENTS.md
  2. 如有同步需求，更新 AGENTS.md 相应章节
  3. 检查 wiki 是否引用旧规则，必要时更新
  4. 跑 Lint 确认无矛盾
  5. 写入 log.md：## [YYYY-MM-DD] soul-sync | {changes}
```
